...
import BussinessReunion from "../bussinessController/BussinesReunion";
import { IClientes } from "../modelos/Clientes";
import { IReunion } from "../modelos/Agenda";
...
class RoutesController {
  public async createClient(request: Request, response: Response) {
    var client: BussinesClientes = new BussinesClientes();
    var clientData = request.body;
    var ClientD: IClientes = clientData;
    try {
      if (
  ...
  public async getClient(request: Request, response: Response) {
    let client: BussinesClientes = new BussinesClientes();
    try {
      let clientData: Array<IClientes> = await client.readClientes();
  ...
  public async getTypeClient(request: Request, response: Response) {
    ...
    //console.log(date);
    try {
      let clientData: Array<IClientes> | IClientes = await client.getTypeClient(
        date
      );
      response.status(200).json({ serverResponse: clientData });
    } catch (err) {
  ...
  public async getNameClientR(request: Request, response: Response) {
    ...
    try {
      if (tipo && (tipo == "Potencial" || tipo == "Regular")) {
        let clientData: Array<IClientes> | IClientes =
  ...
  public async updateClient(request: Request, response: Response) {
    var user: BussinesClientes = new BussinesClientes();
  ...
  public async uploadPortrait(request: Request, response: Response) {
    ...
    try {
      ...
      var client: BussinesClientes = new BussinesClientes();
      var clientToUpdate: IClientes = await client.readClientes(id);
      if (!clientToUpdate) {
    ...
    for (var i = 0; i < key.length; i++) {
      ...
      if (
        ...
        try {
          var userResult: IClientes = await clientToUpdate.save();
  ...
  public async clientgetportrait(request: Request, response: Response) {
    ...
    try {
      ...
      var client: BussinesClientes = new BussinesClientes();
      var clientData: IClientes = await client.readClientes(id);
  ...
  public async addPedidoClients(request: Request, response: Response) {
    ...
    try {
      var pedidoclient: BussinesClientes = new BussinesClientes();
